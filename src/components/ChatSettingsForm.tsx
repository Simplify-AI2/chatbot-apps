...
const DUMMY_CHAT_SETTINGS: ChatSettings = {
  ...
  name: '',
  description: '',
  instructions: 'SimplifyAI – Industry Chatbot currently supports the Power, Health, Technology, Media, and Telecommunications sectors.',
  model: null,
  seed: null,
  temperature: null,
  top_p: null
      ...
      <div className="w-full md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto pt-3">
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 px-8 pt-6 pb-8 mb-4">
          ...
          <div className="mb-4">
            ...
            />
            <small className="text-xs text-gray-500 dark:text-gray-400 mt-1 block">Select the AI model for this chat. Some models may have different capabilities or costs.</small>
          </div>
          */}
          <div className="mb-4">
